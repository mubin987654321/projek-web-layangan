...
export default function JuryLayout({ children, header }) {
    ...
    const desktopWidth = collapsed ? 68 : 256;
    ...
    const SidebarContent = ({ isDrawer = false }) => (
        <>
            ...
            <div className={`relative z-10 flex items-center py-5 shrink-0 transition-all duration-300
                             ${(!isDrawer && collapsed) ? 'px-4 justify-center' : 'px-5 gap-3.5'}`}
                ...
                {isDrawer && (
                    <button
                        ...
                        style={{ background: 'rgba(59,130,246,0.15)', color: '#bfdbfe' }}
                    >
                        <X size={15} />
                    </button>
                )}
                        ...
                        <motion.div key={item.href}
                            ...
                            <Link href={route(item.href)}
                                ...
                                className={`relative flex items-center rounded-xl transition-all duration-200 overflow-hidden
                                            ${(!isDrawer && collapsed) ? 'justify-center py-3.5 px-0' : 'gap-3.5 px-4 py-3.5'}`}
                                style={active ? {
            ...
            <AnimatePresence>
                {isMobile && drawerOpen && (
                    <motion.aside
                        ...
                        className="fixed top-0 left-0 w-68 h-screen flex flex-col z-50 overflow-hidden"
                        style={{
                            width: 272,
                            background: 'linear-gradient(170deg, #080618 0%, #0e0c2e 40%, #080618 100%)',
                            borderRight: '1px solid rgba(59,130,246,0.12)',
                            boxShadow: '8px 0 40px rgba(59,130,246,0.15)',
                        }}
                    >
                ...
                <motion.header
                    ...
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="text-[10px] font-semibold mt-0.5 hidden sm:block" style={{ color: 'rgba(59,130,246,0.6)' }}>
